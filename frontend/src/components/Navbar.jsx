  ...
  return (
    <nav className="container mx-auto flex items-center justify-between py-4 px-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* Cart Icon */}
        <button className="cursor-pointer hover:text-black p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500" aria-label="Shopping cart">
      ...
      {isSearchOpen && (
        <div className="flex items-center justify-center w-full transition-all duration-300 absolute top-0 left-0 bg-white h-24 z-50">
          <form
            onSubmit={handleSearchSubmit}
